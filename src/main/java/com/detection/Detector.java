...
public class Detector {
    ...
    private CarPredictor carPredictor = new CarPredictor();

    public static void main(String[] args) throws java.lang.Exception {
        new Detector().startRealTimeVideoDetection("resources/videoSample.mp4");
    }
    ...
    public void startRealTimeVideoDetection(String videoFileName) throws java.lang.Exception {
        ...
        while (!stop) {
            ...
            if (thread == null) {
                thread = new Thread(() -> {
                    while (videoFrame[0] != null && !stop) {
                        try {
                            carPredictor.markWithBoundingBox(v[0], videoFrame[0].imageWidth, videoFrame[0].imageHeight, true, winname);
            ...
            carPredictor.markWithBoundingBox(v[0], videoFrame[0].imageWidth, videoFrame[0].imageHeight, false, winname);
