...
//        new SmileClassifier().recognizeSmile("C:\\gitlab\\ml\\ml-java\\datasets\\merged\\smile\\file0029.jpg");
        System.out.println(new EmotionClassifier().classify("C:\\gitlab\\ml\\ml-java\\datasets\\merged\\smile\\file0029.jpg"));
//        new SmileClassifier().recognizeSmile("C:\\gitlab\\facial_expressions\\processed\\neutral\\Adam_Ant_0001.jpg");
        System.out.println(new EmotionClassifier().classify("C:\\gitlab\\facial_expressions\\processed\\neutral\\Adam_Ant_0001.jpg"));
//        new SmileClassifier().recognizeSmile("C:\\gitlab\\facial_expressions\\processed\\sadness\\Avinash_12.jpg");
        System.out.println(new EmotionClassifier().classify("C:\\gitlab\\facial_expressions\\processed\\sadness\\Avinash_12.jpg"));
    }
}
